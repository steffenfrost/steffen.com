...
/*
     FILE ARCHIVED ON 0:28:52 Jan 24, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 3:33:14 May 20, 2016.
...
{newQueryParams[property]=value;}});movieURL="/web/20150124002852/http://www.youtube.com/v/"+videoGUID;var queryParamString=$H(newQueryParams).toQueryString();movieURL+=((queryParamString.length==0)?"":("&"+queryParamString));if(movieURL!=this.preferenceForKey("movieURL"))
{this.redoThumbnail(videoGUID);}
var normalizedAddress="/web/20150124002852/http://www.youtube.com/watch?v="+videoGUID;this.setPreferenceForKey(normalizedAddress,"lastNormalizedAddress",false);this.setPreferenceForKey(normalizedAddress,"address",false);var rel=params['rel'];if(rel!==undefined)
...
{this.thumbnailURL=null;var thumbnailURL=null;new Ajax.Request("/web/20150124002852/http://gdata.youtube.com/feeds/api/videos/"+videoGUID,{method:'get',onFailure:function(request)
{this.setPreferenceForKey(false,"x-snapshotAvailable",false);this.render();}.bind(this),onSuccess:function(request)
{var entryNode=ajaxGetDocumentElement(request);var mediaNS="/web/20150124002852/http://search.yahoo.com/mrss/";var youTubeNS="/web/20150124002852/http://gdata.youtube.com/schemas/2007";var mediaGroup=entryNode.getElementsByTagNameNS(mediaNS,"group");if(mediaGroup&&mediaGroup[0])
