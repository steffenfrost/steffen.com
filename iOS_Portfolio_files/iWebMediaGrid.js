...
/*
     FILE ARCHIVED ON 0:18:46 Jan 24, 2015 AND RETRIEVED FROM THE
...
{var iWebNamespace='/web/20150124001846/http://www.apple.com/iweb';var thumbnailNamespace='urn:iphoto:property';var truthFeed=this.mURL.indexOf('?webdav-method=truthget')!=-1;if(truthFeed)
...
{titleText=title.firstChild.nodeValue;}
var iWebNamespace='/web/20150124001846/http://www.apple.com/iweb';var thumbnailNamespace='urn:iphoto:property';var richTitleHTML;var richTitle=this.p_firstElementByTagNameNS(item,iWebNamespace,'richTitle');if(richTitle&&richTitle.firstChild&&richTitle.firstChild.nodeValue)
...
{this.object.classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B";this.object.codebase="/web/20150124001846/http://www.apple.com/qtactivex/qtplugin.cab";}}},setMovieTime:function(time)
{if(this.object)
